...
(1,1,'TON01','HDN0001','10000','100000'),
(2,3,'THEP01','HDN0002','10000','100000'),
(3,5,'GACH01','HDN0003','50000','1000000'),
(4,7,'DA01','HDN0004','40000','500000')
...
select * from hoadon_nhap
select * from dongia
update kho set soluong = soluong + 100 where mahh='TON01' 
SELECT h.MALOAI,h.TENHH,h.DONVITINH,h.XUATXU,k.SOLUONG,k.IDKHO from HANGHOA h, KHO k WHERE k.MAHH=h.MAHH
SELECT c.SO_HD_XUAT,c.SOLUONG_XUAT,c.IDXUAT,c.DONGIA_XUAT,k.TENKH,k.SDT,h.TENHH,h.MAHH,n.TENNV,n.DIACHI,v.SOLUONG,m.NGAYLAP_XUAT,h.XUATXU,h.DONVITINH from CT_HOADON_XUAT c,KHACHHANG k,NHANVIEN n,KHO v,HOADON_XUAT m,HANGHOA h where c.SO_HD_XUAT=m.SO_HD_XUAT and m.MAKH=k.MAKH and m.MANV=n.MANV and v.MAHH=h.MAHH and c.IDKHO=v.IDKHO
                
                
SELECT c.*,d.DONGIA,h.DONVITINH from HANGHOA h,DONGIA d,CT_HOADON_NHAP c,HOADON_NHAP n where h.MAHH=d.MAHH and c.MAHH=h.MAHH and n.SO_HD_NHAP=c.SO_HD_NHAP 
